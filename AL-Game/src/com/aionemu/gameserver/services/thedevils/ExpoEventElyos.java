...
public class ExpoEventElyos {
	...
	private static final String BABI_EVENT_SCHEDULE_ELYOS = SempakConfig.BABI_EVENT_SCHEDULE_ELYOS;
...
188052074, 188052075, 188052718, 188052438, 188100099};
        ...
        public static void ScheduleCron(){
             ...
             log.info("Pig Event start to:" + SempakConfig.BABI_EVENT_SCHEDULE_ELYOS + " duration 30 min");
        }
                ...
                ActionObserver observer = new ActionObserver(ObserverType.ATTACKED){
                        ...
                        public void attacked(Creature creature) {
                                if(creature instanceof Player) {
                                        ...
                                        ItemService.addItem(player, id, SempakConfig.BABI_EVENT_COUNT_REWARD);
                                        World.getInstance().doOnAllPlayers(new Visitor<Player>(){
