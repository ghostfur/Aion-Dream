...
public class ExpoEventAsmo {
	...
	private static final String BABI_EVENT_SCHEDULE_ASMO = SempakConfig.BABI_EVENT_SCHEDULE_ASMO;
...
188052074, 188052075, 188052718, 188052438, 188100099};
        ...
        public static void ScheduleCron(){
             ...
             log.info("Pig Event start to:" + SempakConfig.BABI_EVENT_SCHEDULE_ASMO + " duration 30 min");
        }
