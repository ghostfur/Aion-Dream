...
public class EventGebukMantan {
	...
	private static final String MANTAN_EVENT_SCHEDULE = SempakConfig.MANTAN_EVENT_SCHEDULE;
...
166030005, 186000253, 186000242, 186000253, 162000107, 169620062, 188052637};
        ...
        public static void ScheduleCron(){
             ...
             log.info("Gebuk Mantan Event start to:" + SempakConfig.MANTAN_EVENT_SCHEDULE + " duration 30 min");
        }
                ...
                ActionObserver observer = new ActionObserver(ObserverType.ATTACKED){
                        ...
                        public void attacked(Creature creature) {
                                if(creature instanceof Player) {
                                        ...
                                        ItemService.addItem(player, id, SempakConfig.MANTAN_EVENT_COUNT_REWARD);
                                        World.getInstance().doOnAllPlayers(new Visitor<Player>(){
