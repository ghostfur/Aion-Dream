...
public class _10529Protection_Artifact_2 extends QuestHandler
{
	...
	private final static int[] LF6MissionDarkFi75An = {244111}; 
	private final static int[] LF6MissionDarkWi75An = {244112};
	...
	public boolean onZoneMissionEndEvent(QuestEnv env) {
		int[] ilumaQuest = {10520, 10521, 10525, 10526, 10527, 10528};
            ...
            if (targetId == 806075) { //Weatha.
                ...
                switch (env.getDialog()) {
				    case USE_OBJECT: {
						...
						removeQuestItem(env, 182216078, 20);
						removeQuestItem(env, 182216079, 7);
						removeQuestItem(env, 182216080, 1);
    ...
    public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
            int var = qs.getQuestVarById(0);
            if (var == 6) {
				int[] LF6MissionDarkFi75An = {244111}; 
				int[] LF6MissionDarkWi75An = {244112};
				switch (targetId) {
					case 244111: { 
