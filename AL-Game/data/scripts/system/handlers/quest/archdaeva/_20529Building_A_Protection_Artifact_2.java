...
public class _20529Building_A_Protection_Artifact_2 extends QuestHandler
{
	...
	private final static int[] npcs = {806079, 806298, 806299, 806300, 703317, 731716};
	private final static int[] DF6MissionLightFi75An = {244127};
	private final static int[] DF6MissionLightWi75An = {244128};
	...
	public boolean onZoneMissionEndEvent(QuestEnv env) {
		int[] norsvoldQuest = {20520, 20521, 20525, 20526, 20527, 20528};
            ...
            if (targetId == 806079) { //Feregran.
                ...
                switch (env.getDialog()) {
				    case USE_OBJECT: {
						...
						removeQuestItem(env, 182216090, 20);
						removeQuestItem(env, 182216091, 7);
						removeQuestItem(env, 182216092, 1); 
    ...
    public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
            int var = qs.getQuestVarById(0);
            if (var == 6) {
				int[] DF6MissionLightFi75An = {244127};
				int[] DF6MissionLightWi75An = {244128};
				switch (targetId) {
					case 244127: { 
