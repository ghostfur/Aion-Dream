...
public class _10525Agent_Viola_Call extends QuestHandler
{
            ...
            if (targetId == 806075) { //Weatha.
				...
				switch (env.getDialog()) {
					case QUEST_SELECT: {
						...
						removeQuestItem(env, 182216069, 20); 
						removeQuestItem(env, 182216070, 20); 
						removeQuestItem(env, 182216071, 5); 
						return defaultCloseDialog(env, 5, 6, false, false, 182216072, 1, 0, 0);
    ...
    public HandlerResult onItemUseEvent(final QuestEnv env, Item item) {
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
            ...
            int var = qs.getQuestVarById(0);
            if (var == 6) {
				giveQuestItem(env, 182216072, 1); 
				giveQuestItem(env, 182216073, 1); 
